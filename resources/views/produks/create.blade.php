...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="POST" action="/produks" class="mb-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="id_kategori">
                    @foreach ($kategoriproduks as $kategoriproduk)
                        <option value="{{ $kategoriproduk->id }}" @if (old('id_kategori') == $kategoriproduk->id) selected @endif>
